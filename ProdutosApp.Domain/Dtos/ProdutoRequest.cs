...
namespace ProdutosApp.Domain.Dtos
{
    ...
    {
        [MinLength(6, ErrorMessage = "O nome do produto dever pelo menos {1} caractereres.")]
        [MaxLength(100, ErrorMessage = "O nome do produto não pode ter mais de {1} caracteres")]
        ...
        [Range(1, 5, ErrorMessage = "A categoria do produto deve er um valor entre {1} e {2}")]
